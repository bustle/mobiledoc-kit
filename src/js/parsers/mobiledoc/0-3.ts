...
import { MobiledocMarkerType, MobiledocSectionKind } from '../../renderers/mobiledoc/0-2'
...
export default class MobiledocParser {
  ...
  parseCardType([cardName, cardPayload]): MobiledocCard {
  ...
  parseListSection([, tagName, items], post: Post) {
