...
import MobiledocRenderer_0_3_3, { MOBILEDOC_VERSION as MOBILEDOC_VERSION_0_3_3, MobiledocV0_3_3 } from './0-3-3'
import assert from '../../utils/assert'
import Post from '../../models/post'

export type Mobiledoc = MobiledocV0_2 | MobiledocV0_3 | MobiledocV0_3_1 | MobiledocV0_3_2 | MobiledocV0_3_3
export const MOBILEDOC_VERSION = MOBILEDOC_VERSION_0_3_3
...
interface VersionTypes {
  ...
  [MOBILEDOC_VERSION_0_3_3]: MobiledocV0_3_3
}
  ...
  render(post: Post, version: keyof VersionTypes = MOBILEDOC_VERSION_0_3_2): VersionTypes[typeof version] {
    switch (version) {
      ...
      case MOBILEDOC_VERSION_0_3_3:
        return MobiledocRenderer_0_3_3.render(post)
      default:
